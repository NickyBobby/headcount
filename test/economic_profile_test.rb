...
class EconomicProfileTest < Minitest::Test
  def test_takes_in_data_when_created
    ...
    assert_equal economic_profile_data[:median_household_income], ep.median_household_income
    assert_equal economic_profile_data[:children_in_poverty], ep.children_in_poverty
    assert_equal economic_profile_data[:free_or_reduced_price_lunch], ep.free_or_reduced_price_lunch
    assert_equal economic_profile_data[:title_i], ep.title_i
  end
  ...
  def test_returns_title_i_in_year
    ep = EconomicProfile.new(economic_profile_data)
